...
public class AppUser : IdentityUser<int>
{
    ...
    public ICollection<ProductReview> ProductReviews { get; set; } =
        new List<ProductReview>(); // One-to-Many relationship with ProductReview

    public ICollection<WishList> WishLists { get; set; } =
        new List<WishList>(); // One-to-Many relationship with WishList

    public ICollection<Comment> Comments { get; set; } = new List<Comment>(); // One-to-Many relationship with Comment

    public ICollection<Notification> Notifications { get; set; } =
        new List<Notification>(); // One-to-Many relationship with Notification

    public ICollection<AppUserRole> UserRoles { get; set; } =
        new List<AppUserRole>(); // One-to-Many relationship with User Role
}